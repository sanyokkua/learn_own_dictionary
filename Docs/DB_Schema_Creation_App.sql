...
ALTER TABLE "learning"."user_word"
    ADD FOREIGN KEY ("lang_id") REFERENCES "learning"."languages" ("lang_id");

ALTER TABLE "learning"."topic_words"
    ADD FOREIGN KEY ("topic_list_id") REFERENCES "learning"."topic_list" ("topic_list_id");

ALTER TABLE "learning"."topic_words"
    ADD FOREIGN KEY ("word_id") REFERENCES "learning"."user_word" ("word_id");
